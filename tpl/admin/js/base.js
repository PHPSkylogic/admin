...
$(document).ready(function(){
    ...
    $("input[name='price_price[]']").live('change',function(){
    ...
    $("input[name='purch_price[]']").live('change',function(){
        if($('#one_price').attr('checked'))
        {
            var price=$(this).val();
    ...
    $("input[name='price_margin[]']").live('change',function(){
        if($('#one_price').attr('checked'))
        {
            var price=$(this).val();
    ...
    $("input[name='price_discount[]']").live('change',function(){
        if($('#one_price').attr('checked'))
        {
            var price=$(this).val();
	...
	$(".showAllParams").live('click',function(){
		var status='';
