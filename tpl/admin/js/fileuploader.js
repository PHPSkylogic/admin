...
qq.FileUploader = function(o){
	var templete_text_et='Upload photos';
	var templete_text_ru='Загрузить';		
	templete_text=templete_text_ru;  
    this._options = {
        ...
        allowedExtensions: ['jpg', 'jpeg', 'png', 'gif', 'xlsx'],        
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button" > '+templete_text+' </div>' +
...
// '<span class="qq-upload-failed-text">Ошибка</span>' +
        classes: {
            ...
            // used in css to hide progress spinnerА
