 ...
 */
class Stat_abc_ordersController extends BaseController{
	...
	function  __construct($registry, $params)
	{
		...
		$this->tb = "stat_abc_orders";
        $this->name = "ABC-анализ продаж";
		$this->registry = $registry;
        $this->stat = new Stat_abc_orders($this->sets);
        $this->cntDate=4;
	}
	...
	public function indexAction()
	{
        ...
        $vars['product'] = $this->db->rows("SELECT tb1.*,SUM(tb1.amount) AS amount, SUM(tb1.sum) AS total, product.id AS product_id
                                            FROM orders_product tb1
