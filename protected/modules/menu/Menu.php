...
class Menu extends Model
{
	...
	public function add()
	{
		...
		if(isset($_POST['sub'], $_POST['active'], $_POST['url'], $_POST['name'], $_POST['title'], $_POST['keywords'], $_POST['description'], $_POST['body'])&&$_POST['name']!="")
		{
			...
			$param = array($sub, $_POST['active'], $_POST['code']);
			$insert_id = $this->db->insert_id("INSERT INTO `".$this->table."` SET `sub`=?, `active`=?, `code`=?", $param);
		...
		else
		{
			if(isset($_POST['save_id'])&&is_array($_POST['save_id']))
			{
				...
				if(isset($_POST['sub'], $_POST['active'], $_POST['url'], $_POST['id'], $_POST['name'], $_POST['title'], $_POST['keywords'], $_POST['description'], $_POST['body']))
				{
					...
					$param = array($sub, $_POST['active'], $_POST['form'], $_POST['code'], $_POST['id']);
					$this->db->query("UPDATE `".$this->table."` SET `sub`=?, `active`=?, `form`=?, `code`=? WHERE id=?", $param);
