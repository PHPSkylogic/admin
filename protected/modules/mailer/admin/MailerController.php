...
class MailerController extends BaseController
{
	protected $params;
	protected $db;
	private $left_menu = array(array('title'=>'Экспорт данных',
                                    'url'=>'/admin/mailer/act/export',
                                    'name'=>'export'));
    ...
    public function exportAction()
    {
        if(isset($_POST['download'])) {
            ...
            $dataSet = $this->mailer->find(array('table'=>'subscribers',
												  'order'=>'date_add ASC',
												  'type'=>'rows'));
        ...
        $vars['columns'] = $this->db->rows("SHOW COLUMNS FROM subscribers");
