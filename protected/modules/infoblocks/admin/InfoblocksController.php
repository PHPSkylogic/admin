...
class InfoblocksController extends BaseController{
	...
	public function indexAction()
	{
        ...
        $data['left_menu'] = $this->model->left_menu_admin(array('action'=>'infoblocks', 'name'=>$this->name));
	...
	public function editAction()
	{
		...
		if(isset($this->params['duplicate']))$vars['message'] = $this->info->duplicate($vars['edit'], $this->tb);
